...
<?php
    ...
    //처음으로 페이지
    if($page != 1){
        echo "<li><a href='boradSearch.php?page=1&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>처음으로</a></li>";
    }
    //이전 페이지
    if($page != 1){
        $prevPage = $page -1;
        echo "<li><a href='boradSearch.php?page={$prevPage}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>이전</a></li>";
    }
    // echo $boardCount;
    ...
    for($i=$startPage; $i<=$endPage; $i++){
        ...
        echo "<li class='{$active}'><a href='boradSearch.php?page={$i}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>{$i}</a></li>";
    }
    //다음 페이지
    if($page != $endPage && $boardCount != 0){
        $nextPage = $page +1;
        echo "<li><a href='boradSearch.php?page={$nextPage}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>다음</a></li>";
    }
    //마지막 페이지
    if($page != $endPage && $boardCount != 0){
        $prevPage = $page + 1;
        echo "<li><a href='boradSearch.php?page={$boardCount}&searchKeyword={$searchKeyword}&searchOption={$searchOption}'>마지막으로</a></li>";
    }
?>
                        </ul>
                    </div>
