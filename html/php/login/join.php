...
<head>
    ...
    <title>회원 가입</title>
    <!--  주소
        ekfvoddl0321.dothome.co.kr/php/login/join.php 
    -->
    <!-- style -->
    <?php
        ...
        <section class="join-type gray">
            <div class="member-form">
                ...
                <ul class="list">
                    ...
                    <li>개인정보를 수집 및 이용하며, 회원의 개인정보는를 안전하게 취급하고, 교육을 목적으로 사용됩니다.</li>
                </ul>
                        ...
                        <div class="overlap">
                            ...
                            <div class="basic">
                                ...
                                <input type="password" id="youPass" name="youPass" maxlength="20"
                                    placeholder="비밀번호를 적어주세요." autocomplete="off" >
